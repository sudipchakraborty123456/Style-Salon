...
class Header extends React.Component {
    ...
    getnsServiceClicked=()=>{
        debugger;
        this.propshistory.push("/service/gents");
    }
    ...
    render() {
        return (
            <div className="header container-fluid">
                <div className="row">
                    <div className="logo col-12 col-sm-12 col-mg-4 col-lg-4" onClick={()=>this.logoClick()}>
                        <span id="fn">STYLE</span>
                        <br />
                        <span id="ln">SALON</span>
                    </div>
                    <div className="rightSide col-12 col-sm-12 col-mg-4 col-lg-8">
                        <div className="row text-center p-3">
                            <div className="col-6 col-sm-6 col-mg-4 col-lg-4">
                        ...
                        <div className="row text-center">
                            <span className="pages col-3" onClick={()=>this.logoClick()}>HOME</span>
                            <span className="pages col-3"  onClick={()=>this.aboutUsClicked()}>ABOUT US</span>
                            <select className="pages col-3 service" onChange={(e)=>this.serviceChanged(e)}>
                                <option selected disabled>SERVICES</option>
                                <option value="Gents" onSelect={()=>this.getnsServiceClicked()}>Gents</option>
                                <option value="Ladies" onSelect={()=>this.ladiesServiceClicked()}>Ladies</option>
                            </select>
                            <span className="pages col-3" onClick={()=>this.loginClicked()}>LOGIN</span>
                        </div>
                    </div>
                </div>
            </div>
