            ...
            <>
                ...
                <div className="container-fluid">
                    ...
                    <div className="container">
                        ...
                        <br />
                        <div className="row">
                            <h1 className="col-12 col-sm-12 col-mg-6 col-lg-6 text-center">Looks Salon</h1>
                            <div className=" col-12 col-sm-12 col-mg-6 col-lg-6 text-center"><button className="btn">Book Appointment</button></div>
                        </div>
                        <div className="row">
                            <Tabs>
                                <TabList>
